 ...
 * {@link completedCommits.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link completedCommits#newInstance} factory method to
 * create an instance of this fragment.
 */
public class completedCommits extends Fragment {
     ...
     * @return A new instance of fragment completedCommits.
     */
    // TODO: Rename and change types and number of parameters
    public static completedCommits newInstance(String param1, String param2) {
        completedCommits fragment = new completedCommits();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_completed_commits, container, false);

        final RecyclerView rv = (RecyclerView)view.findViewById(R.id.completeCommitRV);
        ...
        query.whereContains("status", "complete");
    ...
    public void addToContractList(contract con, RecyclerView rv){
        contracts.add(con);
        MyAdapter_complete adapter = new MyAdapter_complete(contracts);
